...
# Frame principal
main_frame = Frame(ventana, bg='#1a1a1a')
...
# Lista de canciones
lista_canciones = Listbox(lista_frame, width=60, height=12, bg='#333', fg='white', 
...
Button(reproductor_frame, text='⏮', command=retroceder_cancion, 
       font=('Arial', 12), bg='#333', fg='white', relief='flat', width=3).pack(side='left', padx=5)
Button(reproductor_frame, text='⏯', command=toggle_play, 
       font=('Arial', 12), bg='#4CAF50', fg='white', relief='flat', width=3).pack(side='left', padx=5)
Button(reproductor_frame, text='⏹', command=detener, 
       font=('Arial', 12), bg='#333', fg='white', relief='flat', width=3).pack(side='left', padx=5)
Button(reproductor_frame, text='⏭', command=adelantar_cancion, 
       font=('Arial', 12), bg='#333', fg='white', relief='flat', width=3).pack(side='left', padx=5)
